  ...
  return (
    <div className="flex h-screen justify-center items-center">
      ...
      <div className="w-1/3 bg-[#ECF0E7] p-4 overflow-y-auto">
        ...
        <div className="bg-[#E7D1D1] shadow rounded-lg p-4 mb-4 flex">
          <h3 className="text-lg text-[#37532B] font-semibold">Matcha Corner</h3>
          <p className="text-gray-600">Great matcha and vibes!</p>
        </div>

        <div className="bg-[#E7D1D1] shadow rounded-lg p-4 mb-4">
          <h3 className="text-lg text-[#37532B] font-semibold">Trees</h3>
          <p className="text-gray-600">Cozy atmosphere, highly recommend.</p>
        </div>

        <div className="bg-[#E7D1D1] shadow rounded-lg p-4">
          <h3 className="text-lg text-[#37532B] font-semibold">Cafe Matcha</h3>
